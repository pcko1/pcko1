...
Currently querying the blockchain while borrowing concepts from artificial intelligence for the analysis of on-chain transactions. Poke me if this tech combo hits home.
...
I mostly code in `python` and have experience with 
science: `numpy`, `pandas`, `matplotlib`, `tensorflow.keras`, `torch`, 
visualization: `matplotlib`, `seaborn`
web: `requests`, `bs4`
CI/CD: `unittest`, `coverage`
